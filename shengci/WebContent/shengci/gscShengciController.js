...
function gscShengciController($scope, $http) {
	//范围数据
  //$scope.danci = ["a","b","c","d","e"];
  //$http.get('../ShengciServlet').success(function(response) {
  $http.get('http://localhost:8080/shengci_server/ShengciServlet').success(function(response) {
	  $scope.danci =  response.data;
